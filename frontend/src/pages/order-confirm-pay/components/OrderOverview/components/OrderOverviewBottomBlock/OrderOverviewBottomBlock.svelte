<script lang="ts">
    ...
    import OrderOverviewBottomBlockLayout
        from "@/pages/order-confirm-pay/components/OrderOverview/components/OrderOverviewBottomBlock/OrderOverviewBottomBlockLayout.svelte";
...
<OrderOverviewBottomBlockLayout>
    <OrderRequestSummaryItem
            title="service fee"
            value="{round(serviceFees * pkg.price, 2)}$"
    />
    <OrderRequestSummaryItem
