<script lang="ts">
    ...
    import UserByIdReviewBottomContentLayout
        from "@/pages/users/components/UserByIdReviewBlock/components/UserByIdReview/components/UserByIdReviewBottomContent/UserByIdReviewBottomContentLayout.svelte";
    import UserByIdReviewColumn
        from "@/pages/users/components/UserByIdReviewBlock/components/UserByIdReview/components/UserByIdReviewColumn/UserByIdReviewColumn.svelte";
    import {getPackageDuration} from "@/utils/utils.ts";
    import DividerElement from "@/common-components/DividerElement/DividerElement.svelte";
    import UserByIdReviewService
        from "@/pages/users/components/UserByIdReviewBlock/components/UserByIdReview/components/UserByIdReviewService/UserByIdReviewService.svelte";
