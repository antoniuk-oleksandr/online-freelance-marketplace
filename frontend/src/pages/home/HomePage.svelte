<script lang="ts">
    ...
    import HomeBestFreelancers
        from "@/pages/home/components/HomeBestFreelancersSection/HomeBestFreelancersSection.svelte";
    import HomeFAQSection
        from "@/pages/home/components/HomeFAQSection/HomeFAQSection.svelte";
    ...
    import type {HomeData} from "@/types/HomeData.ts";

    let homeData = $state<HomeData | undefined>();

    request<GetHomeDataRequestResponse>("/home-data", "GET").then((response) => {
