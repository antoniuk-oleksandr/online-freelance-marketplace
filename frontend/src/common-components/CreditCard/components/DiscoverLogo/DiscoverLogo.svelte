<script lang="ts">
    ...
    const unsubscribe = isDarkMode.subscribe((value) => darkMode = value);

    onDestroy(() => unsubscribe());
</script>

<svg xmlns="http://www.w3.org/2000/svg" width="95" height="18" viewBox="0 0 512 86">
    <defs>
        ...
        <filter id="logosDiscover1" width="200%" height="200%" x="-50%" y="-50%" filterUnits="objectBoundingBox">
